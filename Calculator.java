  ...
  Calculator(){
    ...
    //10 numeric ones, period, and the equal sign
		...
		panel1.setLayout(gl);
	 	...
	 	// Add window controls to the panel panel1
		panel1.add(button1);
		panel1.add(button2);
		panel1.add(button3);
		panel1.add(button4);
		...
		// Add the panel pane1 to the center of the window
    windowContent.add("Center",panel1);

		//Create panel panel2 for the arthimatic buttons
    panel2 = new JPanel();
    GridLayout eastL = new GridLayout(4,1);
		panel2.setLayout(gl);

		// Create arthimatic buttons
		buttonPlus = new JButton("+");
		buttonMinus = new JButton("-");
		buttonMultiply = new JButton("*");
		buttonDivide = new JButton("/");

		// Add arthimatic buttons to panel2
	 	panel2.add(buttonPlus);
		panel2.add(buttonMinus);
		panel2.add(buttonMultiply);
		panel2.add(buttonDivide);

		// Add listeners to the arthimatic buttons
		buttonPlus.addActionListener(calcEngine);
		buttonMinus.addActionListener(calcEngine);
		buttonMultiply.addActionListener(calcEngine);
		buttonDivide.addActionListener(calcEngine);

		// Add panel2 to the right of the window
